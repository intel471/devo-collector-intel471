...
from titan_client import ApiClient, Configuration, GIRsApi

log = logging.getLogger(__name__)


class Intel471GIRsPullerSetup(CollectorPullerSetupAbstract):
    ...
    def setup(self, execution_timestamp: datetime):
        ...
        api_client.user_agent += '; Devo Intel 471 GIRs Collector v1.0'
        api_instance = GIRsApi(api_client)
