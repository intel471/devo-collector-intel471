...
from agent.modules.example.collector_example_10_puller_setup import CollectorExample10PullerSetup
...
class CollectorExample10Puller(CollectorPullerAbstract):
    ...
    def _get_persisted_data_info(self) -> dict:
        ...
        previous_state: dict = self.persistence_object.load_state(no_log_traces=True)
    ...
    def _prepare_tag(self):
        ...
        return base_tag.format(
            collector_version=CollectorExample10Puller.FORMAT_VERSION
        )
    ...
    def _create_first_url(self, retrieving_timestamp: datetime, persisted_info=None) -> str:
        ...
        return base_url.format(since=last_timestamp_str)
