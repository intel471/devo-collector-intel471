...
class CollectorExample1Puller(CollectorPullerAbstract):
    ...
    def init_variables(self,
        ...
        log_message = f"{self.name} Starting the execution of init_variables()"
        log.debug(log_message)

        self.collector_variables["username"] = "john_doe"
        self.collector_variables["password"] = "pass_1"

        log_message = f"{self.name} Finalizing the execution of init_variables()"
        log.debug(log_message)
